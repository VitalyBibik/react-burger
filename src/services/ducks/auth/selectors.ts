...
export const getTokenUpdateDate = (store: any) => store[sliceName].tokenUpdateDate
...
export const getForgotPasswordError = (store: any) => store[sliceName].forgotUserPasswordError
export const getSetUserPasswordError = (store: any) => store[sliceName].setUserPasswordError
