...
import {
  ...
  wsAuthInit,
  wsInit,
} from '../../services/ducks/orders/slice';
import { useDispatch, useSelector } from 'react-redux';
import {
  getIsWsConnected,
  getIsWsConnectedAuth,
  getOrders,
  getUserOrders,
} from '../../services/ducks/orders/selectors';
...
export const OrderHistoryDetailCard = memo(() => {
  ...
  const wsConnected = useSelector(
    isAuth ? getIsWsConnectedAuth : getIsWsConnected
  );
  ...
  if (orders.length && wsConnected) {
    ...
    const orderIngredientsArray = currentCard.ingredients.map((el: any) =>
